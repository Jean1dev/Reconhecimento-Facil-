...
public class Reconhecimento {
    public static void main(String args[]) throws FrameGrabber.Exception {
        ...
        String[] pessoas = {"", "Jean", "Jeanluca", "Rafael"};
        camera.start();

        CascadeClassifier detectorFace = new CascadeClassifier(getFile("haarcascade_frontalface_alt.xml"));
    ...
    private static String getFile(String filename) {
        return new File(Reconhecimento.class.getClassLoader().getResource(filename).getFile()).getPath();
    }
}
